...
public class CollectLog {
    public static void main(String[] args) {
        ...
        prop.put("bootstrap.servers", "hadoop001:9092,hadoop002:9092,hadoop003:9092");
        ...
        try {
            BufferedReader bf = new BufferedReader(new FileReader(new File("D:\\abc\\cmcc.json")));// 路径
            String line = null;
